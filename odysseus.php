...
<main>
    ...
    <h1 class = "planetName">Odysseus</h1>

    <h2 class = "price">$10,500,365,000</h2>

    <h2 class = "purchaseButton"><a href="paymentform.php">Purchase Planet</a></h2>

    <figure class = "planetImages">
        <img src="images/planets/odysseus.png" alt="This should show the main planet image">
        <!-- Under the main image will be all the images in a row, smaller than the main image -->
    </figure>

    <article>
        <p class = "description">
            Planet Odysseus feature vast oceans and many small islands many contain beasts such as giants and cyclopes. The oceans
            contain squids and octopus sizes you wish were not real. This planet is prefect for a great adventure in the sea. There are
            several civilizations of humans under the rule of kings. This planet is very dangerous and will definitely give you an adrenalin
            rush on a daily basis. This planet also produces some of the best swords in the galaxy with heavily guarded ancient secrets used.
            The massive ships you will see on this planet will put all others to shame. There consist beaches of yellow, white, black, and
            even pink sand. There is also some of the most clear and clean water here, because of the minimal amount of greenhouse gases being
            released into the atmosphere.
        </p>

        <h3>Features of Firey Planet</h3>
        <ul class = "featureList">
            <li>10.5 million sq. ft. of beach with fine sand of many colors</li>
            <li>Ocean contains over 500 trillion gallons of saltwater </li>
            <li>Tallest peak - Mount Zeus - 65.3 km above sea level</li>
            <li>Contains the largest concentration of Giants in the galaxy</li>
            <li>Waves over 50m in some regions</li>
            <li>Cattle are the primary food source here</li>
        </ul>
    </article>
    <section class="reviews">
        ...
        <section class="displayReviews">
            ...
            $sql = 'SELECT fldName, fldRating, fldTitle, fldReview, fldPlanet FROM tblReviews WHERE fldPlanet = "fakeplanet2"';
            $statement = $pdo->prepare($sql);
            $statement->execute();
