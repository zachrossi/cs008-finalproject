...
<main>
    ...
    <h1 class = "planetName">Fake Planet 1</h1>
    ...
    <article>
        <p class = "description">This is where the planet will be described in great detail.
            ...
            Fake Planet 1 exudes an overwhelming feeling of life and vibrance. One of its most unique features
    ...
    <section class="reviews">
        ...
        <section class="displayReviews">
            ...
            $sql = 'SELECT fldName, fldRating, fldTitle, fldReview, fldPlanet FROM tblReviews WHERE fldPlanet = "fakeplanet1"';
            $statement = $pdo->prepare($sql);
            $statement->execute();
