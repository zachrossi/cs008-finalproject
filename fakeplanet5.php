...
<main>
    ...
    <h1 class = "planetName">Fake Planet 5</h1>

    <h2 class = "price">$8,500,365,000</h2>

    <h2 class = "purchaseButton"><a href="paymentform.php">Purchase Planet</a></h2>

    <figure class = "planetImages">
        <img src="images/planets/planet5.jpg" alt="This should show the main planet image">
    ...
    <section class="reviews">
        ...
        <section class="displayReviews">
            ...
            $sql = 'SELECT fldName, fldRating, fldTitle, fldReview, fldPlanet FROM tblReviews WHERE fldPlanet = "fakeplanet5"';
            $statement = $pdo->prepare($sql);
            $statement->execute();
