...
<main>
    ...
    <figure class = "planetImages">
        <img src="images/planets/jupiter.png" alt="This should show the main planet image">
    ...
    <section class="reviews">
        ...
        <section class="displayReviews">
            ...
            $sql = 'SELECT fldName, fldRating, fldTitle, fldReview, fldPlanet FROM tblReviews WHERE fldPlanet = "jupiter"';
            $statement = $pdo->prepare($sql);
            $statement->execute();
