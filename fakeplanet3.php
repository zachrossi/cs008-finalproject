...
<main>
    ...
    <h1 class = "planetName">Fake Planet 3</h1>
    ...
    <figure class = "planetImages">
        <img src="images/planets/planet3.jpg" alt="This should show the main planet image">
    ...
    <section class="reviews">
        ...
        <section class="displayReviews">
            ...
            $sql = 'SELECT fldName, fldRating, fldTitle, fldReview, fldPlanet FROM tblReviews WHERE fldPlanet = "fakeplanet3"';
            $statement = $pdo->prepare($sql);
            $statement->execute();
