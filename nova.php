...
<main>
    ...
    <h1 class = "planetName">Nova</h1>

    <h2 class = "price">$23,500,365,000</h2>

    <h2 class = "purchaseButton"><a href="paymentform.php">Purchase Planet</a></h2>

    <figure class = "planetImages">
        <img src="images/planets/nova.jpg" alt="This should show the main planet image">
        <!-- Under the main image will be all the images in a row, smaller than the main image -->
    </figure>

    <article>
        <p class = "description">
            Nova is a planet filled with fire and lava rivers that extend the full length of the planet. The planet is devoid of
            all life except for magma snails who drink the lava and use it as a food source. This planet also has oceans of lava
            that radiate vivid beautiful yellow, orange, red. The is plant also features numerous igneous rocks of different shades
            of black. This planet has great economic potential as lava prices are climbing. There is also many volcanoes on this planet.
            Most notable in Mount small one of the biggest in the galaxy. This planet also has an abundance of diamonds beneath the surface.
            This planet will not be up for long act fast before it is sold! You will not regret it.
        </p>

        <h3>Features of Nova</h3>
        <ul class = "featureList">
            <li>3.5 trillion sq. miles. igneous rocks</li>
            <li>Main lagoon contains 425 trillion gallons of lava </li>
            <li>Tallest peak - Mount small - 155.8 km above sea level</li>
            <li>There is not a second a volcano is not erupting on Nova</li>
            <li>Magma snails are a very tasty delicacy</li>
            <li>There are over 300 million lava lakes</li>
        </ul>
    </article>
    <section class="reviews">
        ...
        <section class="displayReviews">
            ...
            $sql = 'SELECT fldName, fldRating, fldTitle, fldReview, fldPlanet FROM tblReviews WHERE fldPlanet = "nova"';
            $statement = $pdo->prepare($sql);
            $statement->execute();
